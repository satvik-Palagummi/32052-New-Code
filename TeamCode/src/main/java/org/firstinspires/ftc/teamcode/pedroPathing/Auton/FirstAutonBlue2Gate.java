...
@Autonomous
public class FirstAutonBlue2Gate extends AutonTemplate {
    ...
    private final Pose thirdShootPose = new Pose(59.5,102, Math.toRadians(45));
    ...
    private final Pose hitLever = new Pose(16.5,72,Math.toRadians(-20));
